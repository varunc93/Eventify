    ...
    return (
      <div>
        ...
        <Segment attached>
                    ...
                    comment.childNodes.map(child => (
                      <Comment.Group>
                        <Comment key={child.id}>
                          <Comment.Avatar src={child.photoURL || '/assets/images/user.png'} />
                          <Comment.Content>
          ...
          <EventDetailsChatForm parentId={0} form={'newComment'} addEventComment={addEventComment} eventId={eventId} />
        </Segment>
      </div>
    );
  }
